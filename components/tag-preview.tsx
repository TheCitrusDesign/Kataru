...
import { TagImage, CoverImage, DateFormatter, PostTag } from '@Posts/components'
        ...
        <div className="global-item-authors">
          <div className="item-author">
            <Link href={{ pathname: `${process.env.NEXT_PUBLIC_URL}/authors/${author.permalink}` }}>
              <TagImage name={author.name} src={author.profilePictureUrl} slug={author.slug} maxWidth="56px" maxHeight="56px" className="rounded-[100px] object-cover" />
            </Link>
          </div>
        </div>
      </motion.div>
